...
| #    | Tâche                     | Description                                  | Statut |
| ---- | ------------------------- | -------------------------------------------- | ------ |
| 7.1  | Initialisation React/Vite | Vite 8 + TypeScript 5.9 + Tailwind v4        | ✅      |
...
### Critères de complétion
- [x] Toutes les pages fonctionnelles et connectées à l'API
- [x] Dark mode par défaut
- [x] Graphiques interactifs (D3.js + Recharts)
- [x] Bundle < 300 KB gzipped (238 KB JS + 5 KB CSS)
...
### Critères de complétion
- [x] Jobs se déclenchent selon le cron configuré
- [x] Chaîne complète : scrape → stats → scoring → portfolio
- [x] Historique accessible via API
- [x] Retry automatique sur échec (3 tentatives)
...
### Critères de complétion
- [x] Pas d'accès sans token valide
- [x] Chaque rôle limité à ses permissions
- [x] Rate limiting actif (slowapi — login 5/min, register 3/min)
- [x] Audit trail complet pour actions admin
...
### Critères de complétion
- [x] `docker compose up` lance tout le système
- [x] README complet et à jour
- [x] Pas de vulnérabilité critique (OWASP Top 10 couvert)
- [x] Tests passent à 100% (455 backend + 28 frontend)
- [x] Couverture backend 84.65% (≥ 80%)
- [x] Tag v1.0.0
